...
import numpy as np
import json
from visualization.front3d2 import Threed_Front_Config
from visualization.front3d2.tools.threed_front import ThreedFront
from visualization.front3d2.vis_classes import VIS_3DFRONT, VIS_3DFRONT_2D
from visualization.front3d2.tools.utils import parse_inst_from_3dfront, project_insts_to_2d
...
if __name__ == '__main__':
    ...
    for render_path in scene_render_dir.iterdir():
        with h5py.File(render_path) as f:
            ...
            class_segmap = np.array(f["class_segmaps"])
            instance_segmap = np.array(f["instance_segmaps"])
    ...
    viser.visualize(type=['mesh', 'pointcloud', 'cam_pose', 'bbox', ])
