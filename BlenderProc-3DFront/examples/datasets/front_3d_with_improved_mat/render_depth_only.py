...
examples/datasets/front_3d_with_improved_mat/render_depth_only.py \
...
/work/vig/hieu/3dfront_data/test_depth_only \
--poses_folder /work/vig/hieu/3dfront_data/poses_all \
--error_folder /work/vig/hieu/3dfront_data/test_depth_only_error \
--scene_id 0071fae9-a2ce-481e-8a37-a2d307e1213d \
--seed 0


CUDA_VISIBLE_DEVICES=1 blenderproc run \
