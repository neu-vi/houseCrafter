...
def worker(
    ...
    command = (
        ...
        f" python examples/datasets/front_3d_with_improved_mat/renders_obj_img_layout.py"
        ...
        f" /work/vig/hieu/3dfront_data/obj_images_1500scenes"
        f" /work/vig/hieu/3dfront_data/obj_layout_pcd_1500scenes"
        f" --poses_folder /work/vig/hieu/3dfront_data/obj_poses_all"
        f" --layout_folder /work/vig/hieu/3dfront_data/layouts"
        f" --valid_pose_folder /work/vig/hieu/3dfront_data/valid_obj_poses_1500"
        f" --image_error_folder /work/vig/hieu/3dfront_data/obj_images_1500scenes_error"
        f" --layout_error_folder /work/vig/hieu/3dfront_data/obj_layout_pcd_1500scenes_error"
        f" --depth 0"
        f" --start {start}"
        f" --end {end}"
        f" --step {step}"
...
python examples/datasets/front_3d_with_improved_mat/launch.py --start 0 --end 1500 --start_offset 0 --end_offset 7 --step 7 --gpu 0
"""