...
accelerate launch \
  ...
  "./6DoF/configs/base_layout_rcn_iodepth_v.yaml" \
  "./6DoF/configs/3dfront_layout_rand_curate_explorer.yaml" \
  --tracker_project_name eschernet \
  --weights /projects/vig/hieu/escher/logs_eschernet_3dfront_layout_iodepth_1871_scene_3m_obj_final_rerender_v_pyramid_noise/pipeline-15000
